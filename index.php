	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand"> Shipped !</a>
			</div>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login">
										...
										<p><br/></p>
										<!-- reCAPTCHA -->
						<div class="g-recaptcha" data-sitekey="6LfU00YpAAAAAOb4VLyB-JFBHMpXks3Ci7tiTaxG"   style="width: 120px; transform: scale(0.7); transform-origin: 0 0;"></div>
