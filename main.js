$(document).ready(function(){
	...
	*/
	...
	/*
	Here #login is the login form id, and this form is available in index.php page.
	From here, input data is sent to the login.php page.
	If you get the login_success string from login.php page, it means the user is logged in successfully,
	and window.location is used to redirect the user from the home page to profile.php page.
*/
$("#login").on("submit", function (event) {
    ...
    if (stg1 !== stg2) {
        $("#e_msg").html("Please enter a valid captcha.");
        $(".overlay").hide();
        return;
    }
