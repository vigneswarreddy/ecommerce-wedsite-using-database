...
if(isset($_POST["email"]) && isset($_POST["password"])){
	$recaptchaSecretKey = '6LfU00YpAAAAAOb4VLyB-JFBHMpXks3Ci7tiTaxG'; // Replace with your actual secret key
    ...
    if ($recaptchaResponseData->success) {
        echo "<span style='color:red;'>reCAPTCHA verification failed. Please try again.</span>";
        exit();
    }
